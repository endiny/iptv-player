        ...
        <div className="flex flex-col gap-3 rounded-xl border border-white/10 bg-slate-900/70 p-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-400">
              Clears the loaded playlist and returns to the upload screen.
            </p>
          </div>
          <button
            type="button"
            onClick={handleRemovePlaylist}
            className="self-start rounded-md border border-red-500/40 bg-red-500/10 px-4 py-2.5 text-sm text-red-400 transition hover:border-red-400 hover:bg-red-500/20 hover:text-red-300 active:bg-red-500/30 sm:self-auto"
          >
            Remove
          </button>
        </div>
